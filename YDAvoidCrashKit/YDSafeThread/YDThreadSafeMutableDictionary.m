//
//  YDThreadSafeMutableDictionary.m
//  YDKitDemo
//
...
@implementation YDThreadSafeMutableDictionary{
...
- (BOOL)isEqualToDictionary:(NSDictionary *)otherDictionary {
    ...
    if ([otherDictionary isKindOfClass:YDThreadSafeMutableDictionary.class]) {
        YDThreadSafeMutableDictionary *other = (id)otherDictionary;
        BOOL isEqual;
...
- (BOOL)isEqual:(id)object {
    ...
    if ([object isKindOfClass:YDThreadSafeMutableDictionary.class]) {
        YDThreadSafeMutableDictionary *other = object;
        BOOL isEqual;
        dispatch_semaphore_wait(self->_lock, DISPATCH_TIME_FOREVER);
        dispatch_semaphore_wait(other->_lock, DISPATCH_TIME_FOREVER);
        isEqual = [_dic isEqual:other->_dic];
